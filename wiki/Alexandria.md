...
| [[Alexandria Nextcloud]] | Active | HTTP `:80` | Cloud, calendar, contacts, tasks, and news |
| [[Alexandria Vaultwarden]] | Active | `0.0.0.0:8222` | Password manager; signups disabled |
| [[Alexandria Vector]] | Active | Vector API as configured | Logs and host metrics to Rome |

## Network

Alexandria is `192.168.2.4/24`, uses Istanbul (`192.168.2.1`) as gateway and DNS, and permits LAN SSH, HTTP, and Vaultwarden traffic. Istanbul publishes the public routes; see [[Istanbul Nginx]] and [[Istanbul Network Edge|Istanbul network]].
...
- Vector forwards observability data to [[Rome Vector]], [[Rome Prometheus]], and [[Rome Loki]].
