...
- Uses PostgreSQL through [[Babylon PostgreSQL]].
...
> [[Istanbul Coturn]] is disabled, so Matrix calling and relay behavior are not confirmed by the evaluated configuration.
